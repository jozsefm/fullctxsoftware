...
import { ExternalLink, FeedbackDescription, ImageContribution, ImageWrapper, SubScore } from 'components/reviews/common'
import { stage10score } from 'constants/scores/next'
...
export default function Feedback() {
  return (
    <>
      ...
      <FeedbackDescription />
      <Paragraph minorNext>
        Strictly speaking, the last stage is also outside of the responsibility of these types of frameworks. However,
      ...
      <Paragraph minorNext id='user-insights'>
        ...
        are essential to many businesses and is supported by tools such as <ExternalLink href='https://www.hotjar.com/'>
          Hotjar
        </ExternalLink>, <ExternalLink href='https://www.crazyegg.com/'>
          Crazyegg
          ...
          Freshmarketer
        </ExternalLink> or the GDPR compliant <ExternalLink href='https://hockeystack.com/'>
          HockeyStack
        </ExternalLink>.
      </Paragraph>
      <Paragraph minorNext>
        All in all, the availability of the tools built for the web is an awesome, but very much expected, standard property
        of these metaframeworks. It's only worth mentioning, as your options could be more restricted if Next.js was targeting a different platform altogether. <i>
          (eg. Linux desktop)
        </i>
      </Paragraph>
