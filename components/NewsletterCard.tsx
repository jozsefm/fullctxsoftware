      ...
      <Stack
        ...
        <Stack align={'center'} spacing={2}>
          ...
          <Text fontSize={'lg'} color={'gray.500'}>
            Sign up to the newsletter & stay up to date!
          </Text>
        </Stack>
        <Stack as={'form'} spacing={4} direction={{ base: 'column', md: 'row' }} w={'full'} onSubmit={onSubmit}>
          <Input
            type={'text'}
        ...
        <Text
          ...
          {error
            ...
            : state === 'success'
              ? <span>You have subscribed! 🎉 <br/> Please use the confirmation email we sent.</span>
              : ''
          }
        </Text>
      </Stack>
