export const getUpdateEmailHTML = ({ link, name }) => {
  return `
              ...
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                ...
                <tr>
                  <td width="100%" cellpadding="0" cellspacing="0" style="word-break: break-word;">
                    <table align="center" cellpadding="0" cellspacing="0" role="presentation" style="max-width: 590px; width: 100%;">
                      <tr>
                        <td style="word-break: break-word; padding: 35px; font-size: 15px; color:#51545E;">
                          <h1 style="font-size: 22px; margin: 0 auto 35px auto; line-height: 1.6; color: #333333; text-align: center;">
                            ${name? name + ' says ' : ''}Hi! 👋
                          </h1>
                          <p style="line-height: 1.8; margin-bottom: 35px;">
                            You received this letter because one of our users wants to change their account address to this one.
                            If it was you, please use the button below to finish the process. <strong>It's only valid for 1 hour.</strong>
                          </p>
                            ...
                            <tr>
                              <td align="center" style="word-break: break-word;">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                  <tr>
                                    <td align="center" style="word-break: break-word;">
                                      <a href="${link}" target="_blank" style="background-color: #808080; border-top: 10px solid #808080; border-right: 20px solid #808080; border-bottom: 10px solid #808080; border-left: 20px solid #808080; color: white; text-decoration: none; border-radius: 6px; box-shadow: 0 2px 3px rgb(0 0 0 / 16%);">Confirm</a>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                          ...
                          <p style="margin-top: 40px; line-height: 1.8;">
                            If you got this email by mistake don't worry, most likely one of the users made a typo in their own address. 
                            In case of trouble with the process or if you keep receiving unwanted emails please <a href="https://www.fullcontextdevelopment.com/support" target="_blank" style="color: #666975;">contact support</a>.
                          </p>
                      ...
                      <tr>
                        <td align="start" style="font-size: 12px; color: gray; line-height: 1.5; word-break: break-word; padding: 0 35px; text-align: start;">
                          <p style="padding-top: 35px; border-top: 1px solid #cacaca; margin-top:0;">
                            You received this message, because a user of Full Context Software Development tried to change their email address. 
