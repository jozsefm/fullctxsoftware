export const getAuthCodeHTML = ({ code }) => {
  return `
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body style="font-family: Tahoma, Verdana, Geneva, sans-serif; width: 100% !important; height: 100%; margin: 0;">
        <span style="display: none !important; visibility: hidden; mso-hide: all; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; opacity: 0; overflow: hidden;">
          Notification - Here's your team admin authorization code
        </span>
                    ...
                    <table align="center" cellpadding="0" cellspacing="0" role="presentation" style="max-width: 590px; width: 100%;">
                      <tr>
                        <td style="word-break: break-word; padding: 35px; font-size: 15px; color:#51545E;">
                          <h1 style="font-size: 22px; margin: 0 auto 15px auto; line-height: 1.6; color: #333333; text-align: center;">Hi! 👋</h1>
                          <p style="line-height: 1.8;">You or one of your teammates requested an authorization code to access and manage the team profile.
                            You can copy&amp;paste it to the site. <b>It's only valid for 5 minutes.</b>
                          </p>
