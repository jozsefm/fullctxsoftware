export const getTeamSignupHTML = ({ name, hashLink }) => {
  return `
                    ...
                    <table align="center" cellpadding="0" cellspacing="0" role="presentation" style="max-width: 680px; width: 100%;">
                      <tr>
                        <td style="word-break: break-word; padding: 35px; font-size: 15px; color:#51545E;">
                          ...
                          <p style="line-height: 1.8;">I'm absolutely thrilled that your team have joined us and
                            sincerely hope you all will enjoy the book and take away a lot of useful ideas and practices.
                            I'd love to hear about your experience, feel free to hit me up through any of the channels!
                            You might wonder how team management works on the site, if that's the case make sure to check out the detailed
                            <a href="https://www.fullcontextdevelopment.com/pricing#teams" target="_blank" style="color: #808080;">description</a>.
                          </p>
                          <h1 style="font-size: 22px; margin: 35px auto 15px auto; line-height: 1.6; color: #333333;">
                            Here's how your team can access the book:
                          </h1>
                          <p style="line-height: 1.8; margin-bottom: 35px;">
                            ...
                            You got your team's <i><b>very secret</b></i> login URL below. Share it with everyone and use it
                            to get instantly authenticated on the site. That will keep each member logged in for 14 days in their browser.
                            The system allows 2 parallel sessions* per member on a team account. (*Not counted individually)
                          </p>
