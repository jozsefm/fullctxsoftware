export const getHashResetHTML = ({ name, resetLink }) => {
  return `
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body style="font-family: Tahoma, Verdana, Geneva, sans-serif; width: 100% !important; height: 100%; margin: 0;">
        <span style="display: none !important; visibility: hidden; mso-hide: all; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; opacity: 0; overflow: hidden;">
          Use this link to generate a new access code in the next hour.
        </span>
                    ...
                    <table align="center" cellpadding="0" cellspacing="0" role="presentation" style="max-width: 680px; width: 100%;">
                      <tr>
                        <td style="word-break: break-word; padding: 35px; font-size: 15px; color:#51545E;">
                          ...
                          <p style="line-height: 1.8;">Somebody just requested a new access link for this account.
                            If it wasn't you, no need to worry, most likely one of the users made a typo in their address.
                            Nothing happens until you hit the link down below. <b>It's only valid for 1 hour.</b>
                          </p>
                          ...
                          <p style="line-height: 1.8; margin-bottom: 35px;">
                            Follow this URL to get your new access link. Remember, this will terminate all current login sessions of this account.
                          </p>
                            ...
                            <tr>
                              <td align="center" style="word-break: break-word;">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                  <tr>
                                    <td align="center" style="word-break: break-word;">
                                      <a style='color: black;'href="${resetLink}">${resetLink}</a>
                                    </td>
                                  </tr>
                                </table>
                              </td>
