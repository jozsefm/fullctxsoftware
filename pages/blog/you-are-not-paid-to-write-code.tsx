...
const postSEO = {
  title: "You are not paid to write code • Blog • Full Context Development",
  description: "As a software engineer the ultimate goal of your work is not to produce code but to create revenue. Do you know how to do that?",
  canonical: 'https://www.fullcontextdevelopment.com/blog/you-are-not-paid-to-write-code',
  openGraph: {
    url: 'https://www.fullcontextdevelopment.com/blog/you-are-not-paid-to-write-code',
    title: 'You are not paid to write code',
    description: 'The ultimate goal of a software engineer is not to produce code. Then what?',
    site_name: 'Full Context Development Blog',
    type: 'article',
    images: [
      {
        url: 'https://www.fullcontextdevelopment.com/img/blog/hotlink-ok/social/not-paid-to-code.png',
        width: 1600,
        height: 900,
        alt: 'You are not paid to code - Full Context Development Blog',
        type: 'image/png',
      },
    ],
  }
...
export default function Post() {
  return (
    <PostLayout
      ...
      svg={svg}
      imgAlt={IMG_DATA.notCode.alt}
      imgSrc={IMG_DATA.notCode.src}
      publishDate={POST_DATES.notCode.published}
      emphasis
    >
      <NextSeo {...postSEO} />
      <>
...
const svg = ""